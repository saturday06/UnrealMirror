...
void UAutoScreenshotSubsystem::OnWorldBeginPlay(UWorld &InWorld)
{
	...
	InWorld.GetTimerManager().SetTimer(ScreenshotTimerHandle, this, &UAutoScreenshotSubsystem::TakeScreenshotAndExit,
									   10.0f, false);
}
...
void UAutoScreenshotSubsystem::TakeScreenshotAndExit()
{
	...
	const FString ScreenshotPath = FPlatformMisc::GetEnvironmentVariable(TEXT("UNREAL_MIRROR_SCREENSHOT_PATH"));
